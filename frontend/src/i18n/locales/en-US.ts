export default {
  ...
  knowledgeEditor: {
    ...
    conflict: {
      ...
      description: 'Content conflicts detected between files in this knowledge base. Adjudicate with "Keep both / New wins / Old wins / Not a conflict".',
      refresh: 'Refresh',
      loadError: 'Failed to load conflicts',
      resolveSuccess: 'Resolved',
      resolveError: 'Resolution failed',
      statPending: 'Pending',
      statNotConflict: 'Marked not a conflict',
