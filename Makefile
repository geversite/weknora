...
# Usage: make experiment-public-vitaminc-plan VITAMINC_DEVELOPMENT=$HOME/weknora-public-data/vitaminc_real.zip VITAMINC_HOLDOUT=$HOME/weknora-public-data/vitaminc_real.zip PUBLIC_OUTPUT=$HOME/weknora-public-data/vitaminc-real-v1 [DEV_PER_LABEL=10] [HOLDOUT_PER_LABEL=30]
...
# Usage: make experiment-public-pair-eval PUBLIC_MANIFEST=$HOME/weknora-public-data/<plan>/pair_eval_manifest.json [SPLIT=development|holdout|all] [PUBLIC_REPLICATES=1] [PUBLIC_MAX_CASES=10] [PUBLIC_TEMPLATE_KB=<id>] [PUBLIC_OUTPUT=<dir>] [PUBLIC_RESUME=1]
